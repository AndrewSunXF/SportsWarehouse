...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/style_plain.css">
...
<body>
	<header>
		<div>
			<nav id="topNav">
				<div id="shoppingCart"><a href="shopping.php"><i class="fas fa-shopping-cart"></i><span id="cartText">View Cart</span><span id="itemCounter"><?= $countTotalItems ?> items</span></a></div>

				<a href="javascript:void(0);" class="burger" onclick="myFunction()"><i class="fas fa-bars"></i><div id="textMenu">Menu</div></a>
				
				<div id="burgerLinks">
					<a href="login.php" id="loginIcon"><i class="fas fa-lock"></i>Login</a>
					<a href="homePage.php"><i class="far fa-circle"></i>Home</a>
					<a href="#"><i class="far fa-circle"></i>About SW</a>
					<a href="contactPage.php"><i class="far fa-circle"></i>Contact Us</a>
